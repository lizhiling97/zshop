    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#user-set").click(function() {
                $("#frame-id").attr("src", "${pageContext.request.contextPath}/backend/customer/show");
            });
    ...
    <div class="content-cc">
        ...
        <div class="clear-bottom head">
            <div class="container head-cc">
                ...
                <div class="welcome">
                    <div class="left">
                        <c:if test="${sysuser != null}">欢迎您: ${sysuser.loginName}</c:if>
                        <a href="login.jsp"><c:if test="${sysuser == null}">请登录</c:if></a>
                    </div>
